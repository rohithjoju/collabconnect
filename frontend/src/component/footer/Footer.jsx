      ...
      <div className="footer-container">
        <div className="about-footer">
          ...
          <div className="Contact-contribute-container">
              <a href="mailto:rohithjoju25@gmail.com" className="about-us-title" target="blank">Contact Us</a>   
              <a href="https://github.com/rohithjoju/collabconnect" className="about-us-title" target="blank">Want to contribute</a>   
          </div>
          </div>
